    ...
    .then(rawData => {        
        ...
        // //use a for loop to the /top 7 F1 drivers
            ...
            for(let i = 0; i <7; i++){  
                ...
                // All other cells are added to the bottom of the table (-1) - NAME
                ...
                // All other cells are added to the bottom of the table (-1) - NATIONALITY
                ...
                // All other cells are added to the bottom of the table (-1) - SPONSOR
                ...
                // All other cells are added to the bottom of the table (-1) - POINTS
